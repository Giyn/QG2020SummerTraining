...
![存在多个划分超平面将两类训练样本分开](S:\GDUT\Freshman\Freshman summer vacation study\QG Studio\Training\MachineLearningAlgorithm\SVM\SVM.assets\存在多个划分超平面将两类训练样本分开.png)
...
![支持向量与间隔](S:\GDUT\Freshman\Freshman summer vacation study\QG Studio\Training\MachineLearningAlgorithm\SVM\SVM.assets\支持向量与间隔.png)
...
![异或问题与非线性映射](S:\GDUT\Freshman\Freshman summer vacation study\QG Studio\Training\MachineLearningAlgorithm\SVM\SVM.assets\异或问题与非线性映射.png)
...
![软间隔示意图.红色圈出了一些不满足约束的样本.](S:\GDUT\Freshman\Freshman summer vacation study\QG Studio\Training\MachineLearningAlgorithm\SVM\SVM.assets\软间隔示意图.红色圈出了一些不满足约束的样本..png)
...
$$
![三种常见的替代损失函数：hinge损失、指数损失、对率损失](S:\GDUT\Freshman\Freshman summer vacation study\QG Studio\Training\MachineLearningAlgorithm\SVM\SVM.assets\三种常见的替代损失函数：hinge损失、指数损失、对率损失.png)
...
![支持向量回归示意图.红色显示出ε-间隔带,落入其中的样本不计算损失.](S:\GDUT\Freshman\Freshman summer vacation study\QG Studio\Training\MachineLearningAlgorithm\SVM\SVM.assets\支持向量回归示意图.红色显示出ε-间隔带,落入其中的样本不计算损失..png)
...
\end{cases}
$$
![ε-不敏感损失函数](S:\GDUT\Freshman\Freshman summer vacation study\QG Studio\Training\MachineLearningAlgorithm\SVM\SVM.assets\ε-不敏感损失函数.png)
